        ...
        <div class="navbar-collapse collapse" id="sidebar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
                {{-- <li class="nav-item {{ setActive(['admin.dashboard']) }}">
                    <a class="nav-link {{ setActive(['admin.dashboard']) }}" href="{{ route('admin.dashboard') }}">
    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav order-md-last flex-row">
            <div class="d-none d-md-flex">
                <div class="nav-item">
                    <a href="?theme=dark" class="nav-link hide-theme-dark px-0" data-bs-toggle="tooltip"
                    ...
                    <a href="?theme=light" class="nav-link hide-theme-light px-0" data-bs-toggle="tooltip"
