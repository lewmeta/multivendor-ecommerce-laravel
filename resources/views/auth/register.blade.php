                            ...
                            <div class="login_wrap widget-taber-content background-white">
                                <div class="padding_eight_all bg-white">
                                    <div class="heading_s1">
                                        <h2 class="mb-5">{{ __('Create an Account') }}</h2>
                                        <p class="mb-30">{{ __('Already have an account?') }} <a href="{{ route('login') }}">{{ __('Login') }}</a>
                                        </p>
                                    </div>
                                        ...
                                        <div class="payment_option mb-30">
                                            <div class="custome-radio">
                                                ...
                                                <label class="form-check-label" for="exampleRadios3"
                                                    ...
                                                    aria-controls="bankTranfer">{{ __('I am a customer') }}</label>
                                            </div>
                                            <div class="custome-radio">
                                                <input class="form-check-input" required="" type="radio"
                                                ...
                                                <label class="form-check-label" for="exampleRadios4"
                                                    ...
                                                    aria-controls="checkPayment">{{ __('I am a vendor') }}</label>
                                            </div>
                                        </div>
